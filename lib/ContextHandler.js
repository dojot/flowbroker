...
module.exports = class ContextHandler {
   ...
   * use the context
   */
  rlockAndGetTenantContext(tenant, contextName) {
   ...
   * use the context
   */
  wlockAndGetTenantContext(tenant, contextName) {
   ...
   * use the context
   */
  rlockAndGetFlowContext(tenant, flowId, contextName) {
   ...
   * use the context
   */
  wlockAndGetFlowContext(tenant, flowId, contextName) {
   ...
   * use the context
   */
  rlockAndGetNodeContext(tenant, flowId, nodeId, contextName) {
   ...
   * use the context
   */
  wlockAndGetNodeContext(tenant, flowId, nodeId, contextName) {
    return this.client.lockAndGetContext(tenant + '/' + flowId + '/' + nodeId +
      '/' + contextName, WLOCK);
  }
   ...
   *
   */
  getNodeContext(tenant, flowId, nodeId, contextName) {
    return this.client.lockAndGetContext(tenant + '/' + flowId + '/' + nodeId +
   ...
   * use the context
   */
  rlockAndGetNodeInstanceContext(tenant, flowId, nodeId, nodeInstance, contextName) {
    return this.client.lockAndGetContext(tenant + '/' + flowId + '/' + nodeId +
   ...
   * use the context
   */
  wlockAndGetNodeInstanceContext(tenant, flowId, nodeId, nodeInstance, contextName) {
    return this.client.lockAndGetContext(tenant + '/' + flowId + '/' + nodeId +
   ...
   *
   */
  getNodeInstanceContext(tenant, flowId, nodeId, nodeInstance, contextName) {
    return this.client.lockAndGetContext(tenant + '/' + flowId + '/' + nodeId +
   ...
   *   gives a string that describes the error
   */
  saveAndUnlockContext(contextId, contextContent) {
