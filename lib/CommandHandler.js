...
class DojotHandler {
  constructor(dataHandler, contextResponseTimeout) {

    let ctxResponseTimeout = contextResponseTimeout || 10000;
    //todo the following attributes need to be exported outside?
    let ctxManagerHost = "flowbroker-context-manager";
    let ctxManagerPort = 5556;
