...
class DataHandler extends dojot.DataHandlerBase {
    constructor() {
        ...
        handlebars.registerHelper('substring', function (context, start) {
            if (context){
                return context.substring(start,context.lastIndexOf("}")) + "}";
            }
            return '';
        });
        ...
        handlebars.registerHelper('parseAndSelect', function (context, key) {
            return JSON.stringify(JSON.parse(JSON.stringify(context))[key]) + "}";
        });
        ...
        handlebars.registerHelper('xml2json', (xml) => {
            try{
            ...
            return result;
                ...
                logger.error(`Error at xml2json helper. Value was ${xml} and error is ${e}`, { filename: 'template' });
            }
        });
